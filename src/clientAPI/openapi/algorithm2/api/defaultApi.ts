...
let defaultBasePath = 'https://virtserver.swaggerhub.com/SENG499-Algorithm2/Algorithm2API/1.0.0';
...
export class Algorithm2API /* DefaultApi*/ {
     ...
     */
    public async predictClassSizes (courseObject?: Array<CourseObject>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<CourseObject>;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Array<CourseObject>;  }>((resolve, reject) => {
