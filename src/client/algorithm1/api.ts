...
export const DefaultApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @param {Schedule} [schedule] This is the request body format.
    ...
    schedulePost: async (
      ...
      if (schedule !== undefined && schedule !== null) {
        localVarHeaderParameter['schedule'] = String(JSON.stringify(schedule));
      }
...
export class DefaultApi extends BaseAPI {
   ...
   * @memberof DefaultApi
   */
  public schedulePost(schedule?: Schedule, options?: AxiosRequestConfig) {
